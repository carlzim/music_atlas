...
async function runTruthCreditApiCase(params: {
  ...
  const expectedTargetReasonIntegrityScore = expectedTargetReasonIntegrityChecks.filter(Boolean).length / expectedTargetReasonIntegrityChecks.length;
  ...
  const expectedTargetReasonIntegrityGap = expectedTargetReasonIntegrityChecks.length - expectedTargetReasonIntegrityChecks.filter(Boolean).length;
