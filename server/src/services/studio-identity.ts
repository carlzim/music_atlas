...
const STUDIO_IDENTITIES: StudioIdentity[] = [
  ...
  {
    key: 'sun_studio_memphis',
    primaryName: 'Sun Studio, Memphis',
    aliases: [
      'Sun Studio',
      'Sun Studios',
      'Sun Studio Memphis',
    ...
    successorNames: [],
    musicBrainzPlaceId: '87e298cb-d108-4edf-ba51-5b96bdab33de',
    musicBrainzPlaceIds: [
  ...
  {
    key: 'fame_studios_muscle_shoals',
    primaryName: 'FAME Studios, Muscle Shoals',
    aliases: [
      'FAME Studios',
      'FAME Recording Studios',
      'FAME Studios Muscle Shoals',
      'FAME Studio',
      'Rick Hall Recording Studios',
    ],
    successorNames: [
      'Muscle Shoals Sound Studio',
      'Muscle Shoals Sound Studios',
    ],
    musicBrainzPlaceId: '3b03d29f-61e2-471c-9652-3c0d5bb2bf38',
    musicBrainzPlaceIds: [
  ...
  {
    key: 'muscle_shoals_sound_studio',
    primaryName: 'Muscle Shoals Sound Studio',
    aliases: [
      'Muscle Shoals Sound Studio',
      'Muscle Shoals Sound Studios',
    ...
    musicBrainzPlaceId: '80b7667e-5cd6-4037-b69e-a153c5417031',
    musicBrainzPlaceIds: [
